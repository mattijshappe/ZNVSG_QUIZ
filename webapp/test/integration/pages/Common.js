sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("vnsg/app", ".html");
		...
		return Opa5.extend("vnsg.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["vnsg/localService/mockserver"], function (mockserver) {
